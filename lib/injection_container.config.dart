...
import 'Solving/Solving%20Root/cubit/solving_root_cubit.dart' as _i12;
...
import 'Timer%20contents/login_repository.dart' as _i3;
...
import 'Timer%20contents/Times%20Page/cubit/times_page_cubit.dart' as _i14;
import 'Timer%20contents/Times%20Page/times_remote_data_source.dart' as _i6;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i9.LoginPageCubit>(
      () => _i9.LoginPageCubit(get<_i3.LoginRepository>()));
  gh.factory<_i10.SolvingRemoteRetrofitDataSource>(
      () => _i10.SolvingRemoteRetrofitDataSource(get<_i8.Dio>()));
  gh.factory<_i11.SolvingRepository>(() => _i11.SolvingRepository(
      solvingRemoteDataSource: get<_i10.SolvingRemoteRetrofitDataSource>()));
  gh.factory<_i12.SolvingRootCubit>(() =>
      _i12.SolvingRootCubit(solvingRepository: get<_i11.SolvingRepository>()));
  gh.factory<_i13.TimerCubit>(
      () => _i13.TimerCubit(timerRepository: get<_i4.TimerRepository>()));
  gh.factory<_i14.TimesPageCubit>(
      () => _i14.TimesPageCubit(timesRepository: get<_i7.TimesRepository>()));
  return get;
}
